...
from ThirdEye.ase22.selforacle.utils_vae import load_vae, load_data_for_vae_training
from ThirdEye.ase22.selforacle.vae_batch_generator import Generator
...
def train_vae_model(cfg, vae, name, x_train, x_test, delete_model, retraining, sample_weights):
    ...
    Train the VAE model
    """
    #where should i get the encoder and decoder
